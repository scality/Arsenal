...
// const LifecycleDateTime = require('../../../lib/models/LifecycleTime');
...
const {
    ...
    filterRules,
    compareTransitions,
} = require('../../../lib/s3middleware/lifecycleHelpers');
...
describe('getApplicableRules', () => {
    it('should return earliest applicable expirations', () => {
        ...
        const res1 = getApplicableRules(filteredRules);
        ...
        const res2 = getApplicableRules(filteredRules);
    ...
    it('should return earliest applicable rules', () => {
        ...
        const res = getApplicableRules(filteredRules);
    ...
    it('should return Transition with Days', () => {
        ...
        const rules = getApplicableRules(applicableRules, object);
    ...
    'array', () => {
        ...
        const rules = getApplicableRules(applicableRules, {});
        assert.strictEqual(rules.Transition, undefined);
    });
...
describe('filterRules', () => {
    it('should filter out Status disabled rules', () => {
        ...
        const res = filterRules(mBucketRules, item, objTags);
    ...
    it('should filter out unmatched prefixes', () => {
        ...
        const res1 = filterRules(mBucketRules, item1, objTags);
        ...
        const res2 = filterRules(mBucketRules, item2, objTags);
    ...
    it('should filter out unmatched single tags', () => {
        ...
        const res1 = filterRules(mBucketRules, item, objTags1);
        ...
        const res2 = filterRules(mBucketRules, item, objTags2);
    ...
    it('should filter out unmatched multiple tags', () => {
        ...
        const res3 = filterRules(mBucketRules, item, objTags3);
    ...
    it('should filter correctly for an object with no tags', () => {
        ...
        [objTags, objNoTagSet].forEach(obj => {
            const res = filterRules(mBucketRules, item, obj);
...
describe('compareTransitions', () => {
    it('should return undefined if no rules given', () => {
        const result = compareTransitions({ }, defaultDateTime);
    ...
    it('should return first rule if second rule is not given', () => {
        ...
        const result = compareTransitions({ transition1 }, defaultDateTime);
    ...
    it('should return second rule if first rule is not given', () => {
        ...
        const result = compareTransitions({ transition2 }, defaultDateTime);
    ...
    it('should return the first rule if older than the second rule', () => {
        ...
        const result = compareTransitions({
            transition1,
            transition2,
            lastModified: '1970-01-01T00:00:00.000Z',
        }, defaultDateTime);
