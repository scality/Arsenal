...
conditions.findConditionKey = (key, requestContext) => {
    ...
    return {
        ...
        // (see Date Condition Operators).
        'aws:EpochTime': now.getTime().toString(),
        ...
        'aws:MultiFactorAuthAge': requestContext.getMultiFactorAuthAge(),
        ...
        's3:signatureversion': requestContext.getSignatureVersion(),
        // s3:authType -- Method of authentication: either "REST-HEADER",
        // "REST-QUERY-STRING" or "POST"
        's3:authType': requestContext.getAuthType(),
        ...
        's3:signatureAge': requestContext.getSignatureAge(),
...
function convertSpecialChars(string) {
    return string.replace(specialCharsRegex, (all, p1) => p1);
}
