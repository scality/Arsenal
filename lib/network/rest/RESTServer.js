...
// This is set to a higher value than rest client's free socket
// timeout (55 seconds) to avoid the risk of triggering ECONNRESET
// errors if the server closes the connection at the time rest client
