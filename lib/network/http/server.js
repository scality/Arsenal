...
class Server {
    ...
    constructor(port, logger) {
        ...
        this._cbOnCheckContinue = (req, res) => this._noHandlerCb(req, res);
        this._cbOnCheckExpectation = (req, res) => this._noHandlerCb(req, res);
    ...
    _onCheckContinue(req, res) {
        return this._cbCheckContinue(req, res);
    }
