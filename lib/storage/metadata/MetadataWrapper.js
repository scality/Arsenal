...
class MetadataWrapper {
     ...
     * This method provides significant performance improvement over the traditional
     * read-modify-write pattern used by putObjectMD for retention operations.
     * 
     ...
     * @return {undefined}
     */
    putObjectRetention(bucketName, objName, retentionInfo, params, log, cb) {
        if (typeof this.client.putObjectRetention !== 'function') {
            return cb(errors.NotImplemented);
        }
        
        this.client.putObjectRetention(bucketName, objName, retentionInfo, params, log, cb);
    }

    /**
     * Gets object metadata with projection support to minimize data transfer.
     * Only fetches specified fields instead of the entire document, providing
     * significant performance improvements for retention validation operations.
     * 
     * @param {String} bucketName bucket name
     * @param {String} objName object name
     ...
     * @return {undefined}
     */
    getObjectMDPartial(bucketName, objName, projection, params, log, cb) {
        if (typeof this.client.getObjectMDPartial !== 'function') {
            return cb(errors.NotImplemented);
        }
        this.client.getObjectMDPartial(bucketName, objName, projection, params, log, cb);
    }

    /**
     * Bulk update retention metadata for multiple objects using MongoDB bulkWrite.
     * Provides significant performance improvements for high-throughput retention operations.
     * 
     * @param {String} bucketName bucket name
     ...
     * @return {undefined}
     */
    bulkUpdateRetention(bucketName, updates, params, log, cb) {
        if (typeof this.client.bulkUpdateRetention !== 'function') {
            return cb(errors.NotImplemented);
        }
        
        this.client.bulkUpdateRetention(bucketName, updates, params, log, cb);
    }
