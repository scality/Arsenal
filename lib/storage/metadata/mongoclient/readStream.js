...
class MongoReadStream extends Readable {
     ...
     * @param {Object} [nonLocalizedFilter] - query fragment hiding the non-localized versions
     */
    constructor(c, options, searchOptions, nonLocalizedFilter) {
        ...
        if (nonLocalizedFilter) {
            // $and keeps a search query on the same field from overwriting the filter, or the other way around
