...
class MongoClientInterface {
    ...
    internalListObject(bucketName, params, extension, vFormat, log, cb) {
        ...
        const cleanup = () => {
            ...
            if (resolvePhdKey && typeof resolvePhdKey.destroy === 'function') {
                resolvePhdKey.destroy();
            }
            if (masterStream && typeof masterStream.destroy === 'function') {
                masterStream.destroy();
            }
            if (versionStream && typeof versionStream.destroy === 'function') {
