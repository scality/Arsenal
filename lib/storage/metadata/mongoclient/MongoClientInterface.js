...
class MongoClientInterface {
    ...
    countItemsV2(log, cb) {
        ...
        this.db.listCollections().toArray((err, collInfos) => {
            ...
            async.mapLimit(collInfos, 10, (value, next) => {
                ...
                // 1. get INFOSTORE
                // 2. trigger scan (with `bucketInfos`)
                // 3. replace bucketList, buckets
                // 4. set this.lastItemScanTime
                // 5. return
                ...
                // // TODO: mongo update __infostore
                // // TODO: res should be based off what is pulled from __infostore
                // return cb(null, res);
            });
        });
        return undefined;
    ...
    countItems(log, cb) {
        ...
        // 1. retrieve bucket properties
        // 2. async call on list of bucket info
