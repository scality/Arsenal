...
class ListRecordStream extends stream.Transform {
    ...
    _transform(itemObj, encoding, callback) {
        ...
        if (!this.hasStarted) {
            ...
            // set startSeq number based on time stamp
            this.emit('info', {
                start: 0,
                end: 10000,
            });
        ...
        //
        // console.log('ITEM TIME STAMP', itemObj.ts);
        // console.log('TIME STAMP TO INT', itemObj.ts.toInt());
        console.log('TIMESTAP TO NUMBER', itemObj.ts.toNumber());
        const timestampNum = itemObj.ts.toNumber();
        // console.log('TIME STAMP TO STRING', itemObj.ts.toString());
        // console.log('TIME STAMP TO JSON', itemObj.ts.toJSON());

        console.log('turn back innto timestamp,', Timestamp.fromNumber(timestampNum));
...
//         next => {
//             return tester.readRecords({ startSeq: 6519603494532415000 }, (err, res) => {
