 ...
 * @return {undefined}
 */
function createMultipartUpload(params, callback) {
    ...
    const mpuParams = {
        ...
        // This is a 0-byte placeholder object. Explicitly provides a fixed-length
        // body to avoid AWS SDK v3 warnings about streams of unknown length.
        Body: Buffer.alloc(0),
        ContentLength: 0,
...
module.exports = createMultipartUpload;
