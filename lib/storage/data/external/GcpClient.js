...
class GcpClient extends AwsClient {
    ...
    // GCP selects the source version with the x-goog-copy-source-generation
    // header, not with an S3-style ?versionId= on the copy source: the S3 form
    // would be read as part of the object name.
    _copySourceVersionSuffix() {
        return '';
    }
