...
class AwsClient {
    ...
    put(stream, size, keyContext, reqUids, callback) {
        ...
        const putCb = (err, data) => {
            ...
            console.log('putCb returning awsKey:', awsKey,
        ...
        if (!stream) {
            console.log('No stream provided, putting empty object');
            console.log('uploadParams:', uploadParams);
            return this._client.putObject(uploadParams, putCb);
        }

        uploadParams.Body = stream;
        console.log('Uploading object with params:', uploadParams);
        console.log('Stream size:', size);
        console.log('Uploading object body:', uploadParams.Body);
