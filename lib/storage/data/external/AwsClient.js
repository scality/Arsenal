    ...
    setup(cb) {
        ...
        this._client.send(new GetBucketLocationCommand({ Bucket: this._awsBucketName }))
            ...
            if (region && isAWS) {
                ...
                // Ensure endpoint is a string (not converted to a provider function)
                const endpoint = typeof this._s3Params.endpoint === 'string' 
                    ? this._s3Params.endpoint 
                    : String(this._s3Params.endpoint || 'http://127.0.0.1:8000');
                
                const clientParams = { 
                    ...this._s3Params, 
                    endpoint,  // Explicitly set as string
                    region 
                };
            ...
            if (!isAWS) {
                ...
                const clientParams = { ...this._s3Params, region: this._s3Params.region || 'us-east-1' };
                ...
                this._client = new S3Client(clientParams);
                this._addRequestLoggingMiddleware();
                console.log('[AwsClient.setup] New client endpoint after error:', this._client.config?.endpoint?.toString());
