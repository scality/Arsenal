        ...
        console.log('[AwsClient] Adding middleware to client');
         ...
         this._client.middlewareStack.add(
            (next, context) => async args => {
                ...
                // Get ContentLength from command input
                const contentLength = context.input?.ContentLength;
                console.log('[Middleware] ContentLength from input:', contentLength);
                
                if (contentLength && args.request?.headers) {
            ...
            { 
                ...
                priority: 'low'  // Run after SDK sets up the request
            }
        );
