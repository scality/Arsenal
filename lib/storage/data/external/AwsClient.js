...
class AwsClient {
    ...
    get(objectGetInfo, range, reqUids, callback) {
        ...
        this._client.send(new GetObjectCommand(params)).then(data => {
            ...
            console.log('AWS GetObjectCommand returned data:', stream);
            console.log('AWS GetObjectCommand returned data type:', typeof stream);
            if (stream && typeof stream.pipe !== 'function' && typeof stream.transformToWebStream === 'function') {
