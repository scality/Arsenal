...
class MultipleBackendGateway {
    ...
    uploadPartCopy(request, location, awsSourceKey, sourceVersionId, sourceLocationConstraintName, config, log, cb) {
        const client = this.clients[location];
        if (client.uploadPartCopy) {
            return client.uploadPartCopy(request, awsSourceKey, sourceVersionId,
