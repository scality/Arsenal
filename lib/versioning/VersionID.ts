...
import base62String_ from 'base-x';
const base62String = base62String_(BASE62);
 ...
 */
export function getInfVid(replicationGroupId) {
 ...
 */
export function generateVersionId(info, replicationGroupId) {
 ...
 * @return {string} - the encoded versionId
 */
export function encode(str, encType = ENC_TYPE_HEX) {
