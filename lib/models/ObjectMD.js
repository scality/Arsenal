...
class ObjectMD {
    ...
    /**
     * Set dataStoreVersionId
     *
     * @param {string} dataStoreVersionId - external backend version id for data
     * @return {ObjectMD} itself
     */
    setDataStoreVersionId(dataStoreVersionId) {
        this._data.dataStoreVersionId = dataStoreVersionId;
        return this;
    }
