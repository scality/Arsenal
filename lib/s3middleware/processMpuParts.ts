 ...
 */
export function createAggregateETag(partETags) {
 ...
 */
export function generateMpuPartStorageInfo(filteredPartList) {
 ...
 */
export function validateAndFilterMpuParts(storedParts, jsonList, mpuOverviewKey,
    splitter, log) {
    let storedPartsCopy = [];
