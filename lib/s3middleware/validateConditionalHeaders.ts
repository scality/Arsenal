...
export function _checkEtagMatch(ifETagMatch, contentMD5) {
...
export function _checkEtagNoneMatch(ifETagNoneMatch, contentMD5) {
    const res = { present: false, error: null };
    if (ifETagNoneMatch) {
        res.present = true;
...
export function _checkModifiedSince(ifModifiedSinceTime, lastModified) {
    const res = { present: false, error: null };
...
export function _checkUnmodifiedSince(ifUnmodifiedSinceTime, lastModified) {
    const res = { present: false, error: null };
 ...
 */
export function checkDateModifiedHeaders(headers, lastModified) {
 ...
 */
export function validateConditionalHeaders(headers, lastModified, contentMD5) {
