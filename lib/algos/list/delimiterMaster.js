...
class DelimiterMaster extends Delimiter {
    ...
    filterV0(obj) {
        ...
        if ((this.prefix && !key.startsWith(this.prefix))
            ...
            //console.log('skipping in filterv0', {obj, prefix: this.prefix, marker: this.nextContinueMarker });
            return FILTER_SKIP;
        }
        ...
        if (versionIdIndex >= 0) {
            //console.log('skip version keys because we have a master version..');
        ...
        if (Version.isDeleteMarker(value)) {
            //console.log('skipping delete marker because master key');
