...
/**
 *  Base class for the delimiter extension. This is here for the legacy reason.
 *  In future versions, metadata should only do delimiting and it's S3 the part
 *  to extract the desired properties of each entry from the received list.
 */
class Delimiter {
    /**
