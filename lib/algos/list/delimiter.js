...
class Delimiter extends Extension {
    ...
    filter(obj) {
        ...
        if ((this.prefix && !key.startsWith(this.prefix))
            ...
            // console.log('skipping in filterV1', { obj,
            //     nextContinueMarker: this.nextContinueMarker,
    ...
    addCommonPrefix(key, index) {
        ...
        console.log('FILTER_SKIP in addCommonPrefix', {key, index, CommonPrefixes: this.CommonPrefixes, continueMarker: this[this.nextContinueMarker]});
        return FILTER_SKIP;
    }
