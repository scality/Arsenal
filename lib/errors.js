...
function deleteConflict() {
    return new ArsenalErrors("DeleteConflict");
}
...
function limitExceeded() {
    return new ArsenalErrors("LimitExceeded");
}
...
function incompleteSignature() {
    return new ArsenalErrors("IncompleteSignature");
}

function internalFailure() {
    return new ArsenalErrors("InternalFailure");
}

function invalidAction() {
    return new ArsenalErrors("InvalidAction");
}

function invalidClientTokenId() {
    return new ArsenalErrors("InvalidClientTokenId");
}

function invalidParameterCombination() {
    return new ArsenalErrors("InvalidParameterCombination");
}

function invalidParameterValue() {
    return new ArsenalErrors("InvalidParameterValue");
}

function invalidQueryParameter() {
    return new ArsenalErrors("InvalidQueryParameter");
}

function malformedQueryString() {
    return new ArsenalErrors("MalformedQueryString");
}

function missingAction() {
    return new ArsenalErrors("MissingAction");
}

function missingAuthenticationToken() {
    return new ArsenalErrors("MissingAuthenticationToken");
}

function missingParameter() {
    return new ArsenalErrors("MissingParameter");
}

function optInRequired() {
    return new ArsenalErrors("OptInRequired");
}

function requestExpired() {
    return new ArsenalErrors("RequestExpired");
}

function throttling() {
    return new ArsenalErrors("Throttling");
}
