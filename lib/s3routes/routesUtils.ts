 ...
 */
export function responseXMLBody(errCode, xml, response, log, additionalHeaders) {
 ...
 * @return {function} - error or success response utility
 */
export function responseJSONBody(errCode, json, response, log, additionalHeaders) {
 ...
 * @return {function} - error or success response utility
 */
export function responseNoBody(errCode, resHeaders, response, httpCode = 200, log) {
    if (errCode && !response.headersSent) {
 ...
 */
export function responseContentHeaders(errCode, overrideParams, resHeaders, response,
    log) {
    if (errCode && !response.headersSent) {
        return XMLResponseBackend.errorResponse(errCode, response, log,
            resHeaders);
 ...
 * @return {undefined}
 */
export function responseStreamData(errCode, overrideParams, resHeaders, dataLocations,
 ...
 * @return {undefined}
 */
export function streamUserErrorPage(err, dataLocations, retrieveDataParams, response,
    corsHeaders, log) {
    setCommonResponseHeaders(corsHeaders, response, log);
 ...
 * @return {undefined}
 */
export function errorHtmlResponse(err, userErrorPageFailure, bucketName, response,
    corsHeaders, log) {
 ...
 * @return {undefined}
 */
export function errorHeaderResponse(err, response, corsHeaders, log) {
 ...
 * @return {undefined}
 */
export function redirectRequest(routingInfo, objectKey, encrypted, response, hostHeader,
    corsHeaders, log) {
 ...
 */
export function getResourceNames(request, pathname, validHosts) {
 ...
 */
export function getNamesFromReq(request, pathname, bucketNameFromHost) {
    const resources = {
        bucket: undefined,
        object: undefined,
        host: undefined,
 ...
 */
export function getBucketNameFromHost(request, validHosts) {
 ...
 */
export function normalizeRequest(request, validHosts) {
 ...
 *  if false
 */
export function isValidObjectKey(objectKey, prefixBlacklist) {
 ...
 */
export function isValidBucketName(bucketname, prefixBlacklist) {
 ...
 */
export function parseContentMD5(headers) {
...
* @returns {undefined}
*/
export function statsReport500(err, statsClient) {
